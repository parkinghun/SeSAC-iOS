...
extension UILabel {
    ...
    func configure(text: String, font: UIFont? = nil, color: UIColor? = nil, bgColor: UIColor? = nil, cornerRadius: CGFloat? = nil, numberOfLines: Int = 1, alignment: NSTextAlignment = .natural) {
        self.text = text
